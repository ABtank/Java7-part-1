...
('abtank','$2a$10$hUj4lTsyYfGGIowTkQxZdOZmvbEqmCgV5ajBHoAUsehBUj','abtank@bk.ru'),
('aytank','$2a$10$hUj4lTsyYfGGIowTkQxZdOZmvbEqmCgV5ajBHoAUsehBUj','abtankbkru@gmail.com')
;
...
INSERT INTO categories (category, descr, creator_id) VALUES
('Бицепсы','',1),
('Грудь','',1),
('Кардио','',1),
('Ноги','',1),
...
INSERT INTO modes (mode, is_start, descr, creator_id) VALUES
('Регулярное',true,'',1),
('Альтернативное',false,'',1),
('Суперсет (начало)',true,'',1),
('Суперсет',false,'',1),
('Дополнительное',true,'',1);
...
INSERT INTO characters (character, descr) VALUES
('Глобальный','Работает больше 2/3 мышечных групп'),
...
INSERT INTO exercises (exercise, category_id, character_id, is_cardio, creator_id) VALUES
('попеременное сгибание предплечий с гантелями с супинацией',1,2,false,1),
...
INSERT INTO workouts (workout, descr, creator_id) VALUES
('Test workout','descr',1);
...
INSERT INTO workouts_exercises (workout_id, exercise_id, ordinal, creator_id) VALUES
(1,1,1,1),
(1,20,2,1),
(1,30,3,1),
(1,40,4,1),
